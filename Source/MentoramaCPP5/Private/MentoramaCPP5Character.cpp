...
void AMentoramaCPP5Character::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AMentoramaCPP5Character::Move);
...
void AMentoramaCPP5Character::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AMentoramaCPP5Character::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
